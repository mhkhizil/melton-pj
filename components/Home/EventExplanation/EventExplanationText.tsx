...
const EventExplanationText = () => {
  const headingText =
    "  font-medium  font-palanquin_dark   leading-[3.5rem] tracking-wider text-[clamp(20px,5.6vw,58px)]";
  const paraText =
    " font-rubik font-normal leading-[2.8rem] text-[clamp(12px,2.4vw,26px)]";
  return (
    <div className=" sm-md:w-[57%] w-full  h-full flex-col items-center py-10">
      <div>
        <h1 className={headingText}>30 Nov 2024</h1>
      </div>
      <div className=" pt-12">
