...
const WelcomeTextComp = () => {
  const headingText =
    "text-[clamp(16px,5.0vw,58px)]  leading-[3.5rem] text-background font-palanquin_dark font-medium text";
  const smallText =
    " font-rubik font-semibold  leading-8 text-background text-[clamp(10px,2.0vw,24px)]";
  return (
    <div className=" w-[68%] bg-accent  rounded-e-xl h-full ">
      <div className=" w-[85%]  m-2 semi-lg:m-6 xl:m-10">
